...
struct MemoryEditor
{
    ...
    bool            (*HighlightFn)(const ImU8* data, size_t off, void* userData);//= 0      // optional handler to return Highlight property (to support non-contiguous highlighting).
    void            *userData;                                  // UserData to be passed to HighlightFn
